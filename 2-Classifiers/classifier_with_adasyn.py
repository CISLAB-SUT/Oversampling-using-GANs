...
ada_X_train_vec, ada_train_y = ada.fit_sample(X_train, y_train)

df = pd.concat([pd.DataFrame(ada_X_train_vec), pd.DataFrame(ada_train_y)], axis=1)
df.to_csv('df_adasyned_nb.csv', index=False, encoding='utf-8')


print(X_train.shape,y_train.shape)
print(X_test.shape,y_test.shape)

print(ada_X_train_vec.shape,ada_train_y.shape)
...
clf.fit(ada_X_train_vec,ada_train_y)
