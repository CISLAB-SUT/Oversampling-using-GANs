...
run_model = 'dgsan'  # seqgan, leakgan, maligan, jsdgan, relgan, evogan, sentigan, catgan, dpgan, dgsan, cot
...
dataset = 'sentineg'  # oracle, image_coco, emnlp_news, amazon_app_book, amazon_app_movie, mr15
...
eval_type = 'bleu-f1'  # standard, rsgan, nll, nll-f1, Ra, bleu3, bleu-f1
d_type = 'Ra'  # S (Standard), Ra (Relativistic_average)
# vocab_size = 29616  # oracle: 5000, coco: 4683, emnlp: 5256, amazon_app_book: 6418, mr15: 6289
vocab_size = 28543  # oracle: 5000, coco: 4683, emnlp: 5256, amazon_app_book: 6418, mr15: 6289
max_seq_len = 50  # oracle: 20, coco: 37, emnlp: 51, amazon_app_book: 40
ADV_train_epoch = 201  # SeqGAN, LeakGAN-200, RelGAN-3000
...
# ===Basic Train===
samples_num = 19840  # 10000, mr15: 2000,
# samples_num = 999 # 10000, mr15: 2000,
